          ...
          <div className="text-div-item">
            ...
            <div>
              ...
              <p className="description-text">
                ...
                aprendizado é acessível e feito para te ajudar a conquistar seus
                objetivos.
              </p>
            </div>
          </div>
          ...
          <div className="text-div-item">
            ...
            <div>
              ...
              <p className="description-text">
                ...
                educação como meio de transformação. Aqui, você encontra apoio e
                motivação para superar qualquer desafio.
              </p>
            </div>
          </div>
        </div>
